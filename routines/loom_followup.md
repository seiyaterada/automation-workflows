...
from the project root `/home/user/automation-workflows`.
...
2. Read `directives/email_followup_automation.md` to understand the intended behaviour
3. If it is a fixable code bug (not a missing credential or API key): fix `execution/email_followup_pipeline.py`, then re-run
